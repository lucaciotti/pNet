...
<head>
    ...
    <meta name="description" content="pNet ">
    <meta name="author" content="Luca Ciotti">

    <meta property="og:title" content="pNet " />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="pNet " />
    <meta property="og:url" content="http://demo.lucaciotti.space/" />
    {{-- <meta property="og:image" content="http://demo.adminlte.acacha.org/img/AcachaAdminLTE.png" />
    <meta property="og:image" content="http://demo.adminlte.acacha.org/img/AcachaAdminLTE600x600.png" />
    <meta property="og:image" content="http://demo.adminlte.acacha.org/img/AcachaAdminLTE600x314.png" /> --}}
    <meta property="og:sitename" content="demo.lucaciotti.space/" />
    <meta property="og:url" content="http://demo.lucaciotti.space/" />
...
<body data-spy="scroll" data-offset="0" data-target="#navigation">
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>pNet</b></a>
            </div>
        ...
        <div id="headerwrap">
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        <h1>Ferramenta Paride on the Net
                            <br>
            ...
            <div class="container">
                <div class="row centered">
                    ...
                    <div class="col-lg-4">
                        ...
                        {{ trans('adminlte_lang::message.post') }} <a
                            href="https://github.com/acacha/adminlte-laravel/issues">{{ trans('adminlte_lang::message.issues') }}</a>
                        {{ trans('adminlte_lang::message.and') }} <a
    ...
    <div id="c">
        <div class="container">
            <p>
                <a href="http://demo.lucaciotti.space"></a><b>pNet</b></a>.<br />
                <strong>Copyright &copy; {{ Carbon\Carbon::now()->year }}.</strong> {{ trans('_message.createdby') }} <a
                    href="#">Luca Ciotti</a>.
            </p>
